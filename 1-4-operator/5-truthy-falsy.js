...
// if (true) console.log('안녕하세요');

// js는 0, '', null, undefined, NaN을 모두 falsy로 취급
// 나머지는 전부 true로 봄
if (false) console.log('안녕하세요1'); // 출력 안됨
if (0) console.log('안녕하세요2'); // 출력 안됨
if (null) console.log('안녕하세요3'); // 출력 안됨
if (undefined) console.log('안녕하세요4'); // 출력 안됨
if (NaN) console.log('안녕하세요5'); // 출력 안됨
if ('') console.log('안녕하세요6'); // 출력 안됨

if ('hello') console.log('안녕하세요7')
if (' ') console.log('안녕하세요8');
if (100) console.log('안녕하세요9');
if (-888) console.log('안녕하세요10');
